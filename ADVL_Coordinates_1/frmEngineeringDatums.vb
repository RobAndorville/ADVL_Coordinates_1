Public Class frmEngineeringDatums
    'The Engineering Datums form is used to create, select and edit engineering datums.
...
#Region " Form Display Methods - Code used to display this form." '----------------------------------------------------------------------------------------------------------------------------
    ...
    Private Sub frmEngineeringDatums_Load(sender As Object, e As EventArgs) Handles Me.Load
        RestoreFormSettings()
        ...
        Main.EngineeringDatum.AddUser()
        Main.AreaOfUse.AddUser()

        UpdateList()
        txtNRecords.Text = Main.EngineeringDatum.NRecords
        txtDatumListFileName.Text = Main.EngineeringDatum.ListFileName
        CurrentRecordNo = 1
        DisplayListData(1)
    End Sub
    ...
    Private Sub btnExit_Click(sender As Object, e As EventArgs) Handles btnExit.Click
        'Exit the form
        Main.EngineeringDatum.RemoveUser()
...
#Region " Form Methods - The main actions performed by this form." '---------------------------------------------------------------------------------------------------------------------------
    ...
    Private Sub btnGetEpsgList_Click(sender As Object, e As EventArgs) Handles btnGetEpsgList.Click
        'Get the Engineering Datum list from the EPSG database.
    ...
    Private Sub UpdateList()
        ...
        For Index = 0 To Main.EngineeringDatum.NRecords - 1
            ListBox1.Items.Add(Main.EngineeringDatum.List(Index).Name)
        Next
    End Sub
    ...
    Private Sub DisplayListData(ByVal RecordNo As Integer)
        ...
        txtEngineeringDatumName.Text = Main.EngineeringDatum.List(RecordNo - 1).Name
        txtDatumAuthor.Text = Main.EngineeringDatum.List(RecordNo - 1).Author
        txtDatumCode.Text = Main.EngineeringDatum.List(RecordNo - 1).Code
        txtDatumDeprecated.Text = Main.EngineeringDatum.List(RecordNo - 1).Deprecated

        'Update the list of alias names:
        cmbDatumAliasNames.Items.Clear()
        cmbDatumAliasNames.Text = ""
        For Each item As String In Main.EngineeringDatum.List(RecordNo - 1).AliasName
        ...
        txtDatumComments.Text = Main.EngineeringDatum.List(RecordNo - 1).Comments
        txtDatumOrigin.Text = Main.EngineeringDatum.List(RecordNo - 1).OriginDescription
        txtDatumScope.Text = Main.EngineeringDatum.List(RecordNo - 1).Scope


        'Display area of use data: ------------------------------------------------------------------------------------------------------------
        txtAreaOfUseName.Text = Main.EngineeringDatum.List(RecordNo - 1).Area.Name
        txtAouCode.Text = Main.EngineeringDatum.List(RecordNo - 1).Area.Code
        txtAreaAuthor.Text = Main.EngineeringDatum.List(RecordNo - 1).Area.Author

        Dim AreaMatch = From Area In Main.AreaOfUse.List Where Area.Author = Main.EngineeringDatum.List(RecordNo - 1).Area.Author And Area.Code = Main.EngineeringDatum.List(RecordNo - 1).Area.Code
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        'Save the Engineering Datum list.
        ...
        If DatumListFileName.EndsWith(".EngDatumList") Then
            'DatumListFileName has correct file extension.
            Main.EngineeringDatum.ListFileName = DatumListFileName
        Else
            'Add file extension to the file name.
            DatumListFileName &= ".EngDatumList"
            Main.EngineeringDatum.ListFileName = DatumListFileName
            txtDatumListFileName.Text = DatumListFileName
        End If

        Main.Project.SaveXmlData(DatumListFileName, Main.EngineeringDatum.ToXDoc())
    End Sub

    Private Sub btnFirst_Click(sender As Object, e As EventArgs) Handles btnFirst.Click
        'Move to the first record in the Engineering Datum list:
        CurrentRecordNo = 1
        DisplayListData(CurrentRecordNo)
    End Sub

    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        'Move to the next record in Engineering Datum List
        If CurrentRecordNo = Main.EngineeringDatum.NRecords Then
    ...
    Private Sub btnPrev_Click(sender As Object, e As EventArgs) Handles btnPrev.Click
        'Move to the previous record in Engineering Datum List
    ...
    Private Sub btnLast_Click(sender As Object, e As EventArgs) Handles btnLast.Click
        'Move to the last record in the Engineering Datum list:
        CurrentRecordNo = Main.EngineeringDatum.NRecords
        DisplayListData(CurrentRecordNo)
    End Sub
    ...
    Private Sub txtRecordNo_TextChanged(sender As Object, e As EventArgs) Handles txtRecordNo.TextChanged
        ...
        If NewRecordNo > Main.EngineeringDatum.NRecords Then
            Exit Sub
        End If
    ...
    Private Sub btnFind_Click(sender As Object, e As EventArgs) Handles btnFind.Click
        'Find an Engineering Datum list file.

        Select Case Main.Project.DataLocn.Type
            Case ADVL_Utilities_Library_1.FileLocation.Types.Directory
                'Select an Engineering Datum list file from the project directory:
                OpenFileDialog1.InitialDirectory = Main.Project.DataLocn.Path
                OpenFileDialog1.Filter = "Engineering Datum List | *.EngDatumList"
            ...
            Case ADVL_Utilities_Library_1.FileLocation.Types.Archive
                ...
                Zip.SelectFileForm.FileExtension = ".EngDatumList"
    ...
    Private Sub FindRecord(ByVal SearchString As String)
        ...
        FoundIndex = Main.EngineeringDatum.List.FindIndex(Function(x) x.Name.Contains(SearchString))
    ...
    Private Sub FindNextRecord(ByVal SearchString As String)
        Dim FoundIndex As Integer
        FoundIndex = Main.EngineeringDatum.List.FindIndex(CurrentRecordNo, Function(x) x.Name.Contains(SearchString))
        If FoundIndex = -1 Then
            Main.Message.Add("String not found." & vbCrLf)
        Else
            CurrentRecordNo = FoundIndex + 1
    ...
    Private Sub FindPrevRecord(ByVal SearchString As String)
        ...
        If CurrentRecordNo > 1 Then
            ...
            FoundIndex = Main.EngineeringDatum.List.FindLastIndex(Start, Function(x) x.Name.Contains(SearchString))
            If FoundIndex = -1 Then
                Main.Message.Add("String not found." & vbCrLf)
            Else
                CurrentRecordNo = FoundIndex + 1
