Public Class frmGeographic2DCRS
    'This form displays the parameters for Geographic 2D Coordinate Reference Systems
...
#Region " Form Display Methods - Code used to display this form." '----------------------------------------------------------------------------------------------------------------------------
    ...
    Private Sub frmGeographic2DCRS_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        UpdateList()
        txtNRecords.Text = Main.Geographic2DCRS.NRecords
        txtGeogr2DCRSListFileName.Text = Main.Geographic2DCRS.ListFileName
        CurrentRecordNo = 1
        DisplayListData(1)
...
#Region " Form Methods - The main actions performed by this form." '---------------------------------------------------------------------------------------------------------------------------
    ...
    Private Sub UpdateList()
        ...
        For Index = 0 To Main.Geographic2DCRS.NRecords - 1
            ListBox1.Items.Add(Main.Geographic2DCRS.List(Index).Name)
        Next
    End Sub
    ...
    Private Sub DisplayListData(ByVal RecordNo As Integer)
        ...
        If RecordNo > Main.Geographic2DCRS.NRecords Then
            Main.Message.SetWarningStyle()
            Main.Message.Add("Cannot display Prime Meridian data. Selected record number is too large." & vbCrLf)
            Exit Sub
        End If

        txtCRSName.Text = Main.Geographic2DCRS.List(RecordNo - 1).Name
        txtCRSName2.Text = Main.Geographic2DCRS.List(RecordNo - 1).Name
        txtCrsAuthor.Text = Main.Geographic2DCRS.List(RecordNo - 1).Author
        txtCrsCode.Text = Main.Geographic2DCRS.List(RecordNo - 1).Code
        txtCrsDeprecated.Text = Main.Geographic2DCRS.List(RecordNo - 1).Deprecated

        'Update the list of alias names:
        cmbCRSAliasNames.Items.Clear()
        cmbCRSAliasNames.Text = ""
        For Each item As String In Main.Geographic2DCRS.List(RecordNo - 1).AliasName
        ...
        txtCrsScope.Text = Main.Geographic2DCRS.List(RecordNo - 1).Scope
        txtCrsComments.Text = Main.Geographic2DCRS.List(RecordNo - 1).Comments

        'Display Area Of Use data:
        txtAOUName.Text = Main.Geographic2DCRS.List(RecordNo - 1).Area.Name
        DisplayAOUData(Main.Geographic2DCRS.List(RecordNo - 1).Area.Author, Main.Geographic2DCRS.List(RecordNo - 1).Area.Code)

        'Display Coordinate System data:
        txtCSName.Text = Main.Geographic2DCRS.List(RecordNo - 1).CoordinateSystem.Name
        txtCSType.Text = Main.Geographic2DCRS.List(RecordNo - 1).CoordinateSystem.Type
        DisplayCSData(Main.Geographic2DCRS.List(RecordNo - 1).CoordinateSystem.Author, Main.Geographic2DCRS.List(RecordNo - 1).CoordinateSystem.Code)

        'Display Datum data:
        txtDatumName.Text = Main.Geographic2DCRS.List(RecordNo - 1).Datum.Name
        txtDatumType.Text = Main.Geographic2DCRS.List(RecordNo - 1).Datum.Type
        DisplayDatumData(Main.Geographic2DCRS.List(RecordNo - 1).Datum.Author, Main.Geographic2DCRS.List(RecordNo - 1).Datum.Code)

        'Display Base Coordinate Reference System data:
        txtBaseCRSName.Text = Main.Geographic2DCRS.List(RecordNo - 1).SourceGeographicCRS.Name
        txtBaseCRSType.Text = Main.Geographic2DCRS.List(RecordNo - 1).SourceGeographicCRS.Type
        DisplaySourceCRSData(Main.Geographic2DCRS.List(RecordNo - 1).SourceGeographicCRS.Author, Main.Geographic2DCRS.List(RecordNo - 1).SourceGeographicCRS.Code)
        ...
        Else
            ...
            If CoordRefSysMatch.Count > 0 Then
                ...
                Select Case CoordRefSysMatch(0).Type
                    'Case ADVL_Coordinates_Library.Coordinates.CoordinateReferenceSystemSummary.CrsTypes.Compound
                    ...
                    Case ADVL_Coordinates_Library_1.CrsTypes.Engineering
                        ...
                        'Case ADVL_Coordinates_Library.Coordinates.CoordinateReferenceSystemSummary.CrsTypes.Geocentric
                    Case ADVL_Coordinates_Library_1.CrsTypes.Geocentric
                        txtSourceCRSType.Text = "Geocentric"
                        'Case ADVL_Coordinates_Library.Coordinates.CoordinateReferenceSystemSummary.CrsTypes.Geographic2D
                    Case ADVL_Coordinates_Library_1.CrsTypes.Geographic2D
                        txtSourceCRSType.Text = "Geographic2D"
                        'Case ADVL_Coordinates_Library.Coordinates.CoordinateReferenceSystemSummary.CrsTypes.Geographic3D
                    Case ADVL_Coordinates_Library_1.CrsTypes.Geographic3D
                        txtSourceCRSType.Text = "Geographic3D"
                        'Case ADVL_Coordinates_Library.Coordinates.CoordinateReferenceSystemSummary.CrsTypes.Projected
                    Case ADVL_Coordinates_Library_1.CrsTypes.Projected
                        txtSourceCRSType.Text = "Projected"
                        'Case ADVL_Coordinates_Library.Coordinates.CoordinateReferenceSystemSummary.CrsTypes.Vertical
                    Case ADVL_Coordinates_Library_1.CrsTypes.Vertical
                        txtSourceCRSType.Text = "Vertical"
                        'Case ADVL_Coordinates_Library.Coordinates.CoordinateReferenceSystemSummary.CrsTypes.Unknown
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Dim CRSListFileName As String = Trim(txtGeogr2DCRSListFileName.Text)

        If CRSListFileName = "" Then
            Main.Message.SetWarningStyle()
            Main.Message.Add("Please enter a file name for the Geographic 2D CRS list!" & vbCrLf)
            Exit Sub
        End If

        If CRSListFileName.EndsWith(".Geogr2DCRSList") Then
            'DatumListFileName has correct file extension.
            Main.Geographic2DCRS.ListFileName = CRSListFileName
        Else
            'Add file extension to the file name.
            CRSListFileName &= ".Geogr2DCRSList"
            Main.Geographic2DCRS.ListFileName = CRSListFileName
            txtGeogr2DCRSListFileName.Text = CRSListFileName
        End If

        Main.Project.SaveXmlData(CRSListFileName, Main.Geographic2DCRS.ToXDoc())
    End Sub
    ...
    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        'Move to the next record in Geographic 2D CRS List
        If CurrentRecordNo = Main.Geographic2DCRS.NRecords Then
    ...
    Private Sub btnPrev_Click(sender As Object, e As EventArgs) Handles btnPrev.Click
        'Move to the previous record in Geographic 2D CRS List
    ...
    Private Sub btnLast_Click(sender As Object, e As EventArgs) Handles btnLast.Click
        ...
        CurrentRecordNo = Main.Geographic2DCRS.NRecords
        DisplayListData(CurrentRecordNo)
    End Sub
    ...
    Private Sub txtRecordNo_TextChanged(sender As Object, e As EventArgs) Handles txtRecordNo.TextChanged
        ...
        If NewRecordNo > Main.Geographic2DCRS.NRecords Then
            Exit Sub
        End If
    ...
    Private Sub btnFind_Click(sender As Object, e As EventArgs) Handles btnFind.Click
        ...
        Select Case Main.Project.DataLocn.Type
            Case ADVL_Utilities_Library_1.FileLocation.Types.Directory
                'Select a Geographic 2D CRS list file from the project directory:
                OpenFileDialog1.InitialDirectory = Main.Project.DataLocn.Path
                OpenFileDialog1.Filter = "Geographic 2D CRS List | *.Geogr2DCRSList"
                If OpenFileDialog1.ShowDialog() = Windows.Forms.DialogResult.OK Then
                    Dim DataFileName As String = System.IO.Path.GetFileName(OpenFileDialog1.FileName)
                    txtGeogr2DCRSListFileName.Text = DataFileName
                    Main.Geographic2DCRS.ListFileName = DataFileName
                    Dim XmlDoc As System.Xml.Linq.XDocument
                    Main.Project.DataLocn.ReadXmlData(DataFileName, XmlDoc)
                    Main.Geographic2DCRS.LoadXml(XmlDoc)
                    UpdateList()
                    txtNRecords.Text = Main.Geographic2DCRS.NRecords
                    txtRecordNo.Text = 1
                    DisplayListData(1)
            ...
            Case ADVL_Utilities_Library_1.FileLocation.Types.Archive
                ...
                'Dim Zip As New ADVL_Utilities_Library.ZipComp
    ...
    Private Sub btnGetEpsgList_Click(sender As Object, e As EventArgs) Handles btnGetEpsgList.Click
        'Get the Geographic2DCRS list from the EPSG database.
    ...
    Private Sub FindRecord(ByVal SearchString As String)
        ...
        FoundIndex = Main.Geographic2DCRS.List.FindIndex(Function(x) x.Name.Contains(SearchString))
    ...
    Private Sub FindPrevRecord(ByVal SearchString As String)
        ...
        If CurrentRecordNo > 1 Then
            ...
            FoundIndex = Main.Geographic2DCRS.List.FindLastIndex(Start, Function(x) x.Name.Contains(SearchString))
            If FoundIndex = -1 Then
                Main.Message.Add("String not found." & vbCrLf)
            Else
                CurrentRecordNo = FoundIndex + 1
    ...
    Private Sub FindNextRecord(ByVal SearchString As String)
        Dim FoundIndex As Integer
        FoundIndex = Main.Geographic2DCRS.List.FindIndex(CurrentRecordNo, Function(x) x.Name.Contains(SearchString))
        If FoundIndex = -1 Then
            Main.Message.Add("String not found." & vbCrLf)
        Else
            CurrentRecordNo = FoundIndex + 1
